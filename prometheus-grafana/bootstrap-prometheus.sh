...
wget https://github.com/prometheus/prometheus/releases/download/v$prom_vers/prometheus-$prom_vers.linux-amd64.tar.gz
...
# Extract files
tar -xvzf /home/vagrant/Downloads/prometheus-$prom_vers.linux-amd64.tar.gz

cd prometheus-$prom_vers.linux-amd64
...
cd /home/vagrant/Prometheus/server/prometheus-$prom_vers.linux-amd64/
...
# download grafana
wget https://dl.grafana.com/oss/release/grafana_${graf_ver}_amd64.deb -O /home/vagrant/Downloads/grafana_${graf_ver}_amd64.deb

sudo apt-get install -y adduser libfontconfig

# install grafana 
sudo dpkg -i /home/vagrant/Downloads/grafana_${graf_ver}_amd64.deb
